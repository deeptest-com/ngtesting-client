...
export class CaseTypeList implements OnInit, AfterViewInit {
  ...
  create(): void {
    this._routeService.navTo('/pages/org-admin/case-settings/case-type/edit/null');
  }

  edit(item: any): void {
    this._routeService.navTo('/pages/org-admin/case-settings/case-type/edit/' + item.id);
  }

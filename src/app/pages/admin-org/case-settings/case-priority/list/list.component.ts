...
export class CasePriorityList implements OnInit, AfterViewInit {
  ...
  create(): void {
    this._routeService.navTo('/pages/org-admin/case-settings/case-priority/edit/null');
  }
  edit(item: any): void {
    this._routeService.navTo('/pages/org-admin/case-settings/case-priority/edit/' + item.id);
  }

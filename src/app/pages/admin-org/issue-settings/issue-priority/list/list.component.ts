...
export class IssuePriorityList implements OnInit, AfterViewInit {
  ...
  create(): void {
    this._routeService.navTo('/pages/org-admin/issue-settings/issue-priority/edit/null');
  }
  edit(item: any): void {
    this._routeService.navTo('/pages/org-admin/issue-settings/issue-priority/edit/' + item.id);
  }
